...
# mark 
from utils.lh_eval import eval_result
import pickle
...
def main():
    ...
    parser.add_argument('--sample_path', type=str, default='./logs_diffusion/training_2024_11_04__10_15_56/checkpoints/993000_12/')
